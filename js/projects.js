...
export class Projects {
    ...
    static #sequelTag = [
      "", ": <em>Aftermath</em>", ": <em>Armageddon</em>", ": <em>Back in Action</em>", ": <em>Code Orange</em>", ": <em>Director's Cut</em>", ": <em>Dominion</em>", ": <em>Extended Edition</em>", ": <em>Final Chapter</em>", ": <em>Intercepted</em>", ": <em>Last Stand</em>", ": <em>Origins</em>", ": <em>Prologue</em>", ": <em>Rebirth</em>", ": <em>Reloaded</em>", ": <em>Remastered?</em>", ": <em>Resurrection</em>", ": <em>Returns</em>", ": <em>Redux</em>", ": <em>Revolution</em>", ": <em>The Awakening</em>", ": <em>The Fall</em>", ": <em>The Better One</em>", ": <em>The Lost Chapters</em>", ": <em>The Reckoning</em>", ": <em>X</em>"
