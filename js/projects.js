...
export class Projects {
    ...
    static #DECK = new MultiWordDeck(new WordDeck(Projects.#ADJECTIVE), new WordDeck(Projects.#THEME), new WordDeck(Projects.#GENRE), new WordDeck(Projects.#SEQUEL_TAG));
    static newProject() {
