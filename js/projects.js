...
export class Projects {
    ...
    static TOTAL_COMBOS = Projects.#ADJECTIVE_LEN * Projects.#THEME_LEN * Projects.#GENRE_LEN * (Projects.#SEQUEL_LEN + 1);
    ...
    static #decodeIndex(index) {
        ...
        return (
            ...
            (sequelIndex !== -1 ? ": <em>" + Projects.#sequelTag[sequelIndex] + "</em>" : "")
        );
    }
    static clearUsed() {
